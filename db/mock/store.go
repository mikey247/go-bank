...
// Source: github.com/mikey247/go-bank/db/sqlc (interfaces: Store)
...
func (m *MockStore) AddAccountBalance(arg0 context.Context, arg1 bankdb.AddAccountBalanceParams) (bankdb.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddAccountBalance", arg0, arg1)
	ret0, _ := ret[0].(bankdb.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) CreateAccount(arg0 context.Context, arg1 bankdb.CreateAccountParams) (bankdb.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) CreateEntry(arg0 context.Context, arg1 bankdb.CreateEntryParams) (bankdb.Entry, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateEntry", arg0, arg1)
	ret0, _ := ret[0].(bankdb.Entry)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) CreateTransfer(arg0 context.Context, arg1 bankdb.CreateTransferParams) (bankdb.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateTransfer", arg0, arg1)
	ret0, _ := ret[0].(bankdb.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) GetAccount(arg0 context.Context, arg1 int64) (bankdb.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetAccountForUpdate(arg0 context.Context, arg1 int64) (bankdb.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetEntry(arg0 context.Context, arg1 int64) (bankdb.Entry, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetTransfer(arg0 context.Context, arg1 int64) (bankdb.Transfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListAccounts(arg0 context.Context, arg1 bankdb.ListAccountsParams) ([]bankdb.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListEntries(arg0 context.Context, arg1 bankdb.ListEntriesParams) ([]bankdb.Entry, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListTransfers(arg0 context.Context, arg1 bankdb.ListTransfersParams) ([]bankdb.Transfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) TransferTx(arg0 context.Context, arg1 bankdb.TransferTxParams) (bankdb.TransferTxResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TransferTx", arg0, arg1)
	ret0, _ := ret[0].(bankdb.TransferTxResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) UpdateAccount(arg0 context.Context, arg1 bankdb.UpdateAccountParams) (bankdb.Account, error) {
	m.ctrl.T.Helper()
